...
class KerasRNNRanking(object):
    ...
    def main(self, embed_hidden_size, rnn_size, loss_name="categorical_crossentropy", optimizer_name="adam",
        ...
        self.model = self.train_network(preds=preds,
                                        ...
                                        answer_1=answer_1,
                                        answer_2=answer_2,
                                        X_train_Q=X_train_Q[:1000],
                                        X_train_A_1=X_train_A_1[:1000],
                                        X_train_A_2=X_train_A_2[:1000],
        ...
        write_predictions_to_file(predictions_for_writing, conf_scores, test_idx_org, prediction_filename)
